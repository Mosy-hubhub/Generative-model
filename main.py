...
def dict2namespace(config):
    # this function converts a dictionary to a namespace object recursively
    ...
    for key, value in config.items():
        if isinstance(value, dict):
            ...
            new_value = value
        # setattr is used to set attribute for an object dynamically
...
def main():
    ...
    try:
        # the function eval() can convert a string to a class object
